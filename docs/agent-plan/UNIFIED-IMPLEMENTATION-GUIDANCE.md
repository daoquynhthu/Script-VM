...
> **Mirror copy.** Master file: `PLAN/UNIFIED-IMPLEMENTATION-GUIDANCE.md`  
> If this file diverges from the master, **the PLAN/ copy wins.**  
> Do not edit only this mirror; update master first, then sync.
